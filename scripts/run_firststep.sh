...
# python -m torch.distributed.launch --master_port=${port} --nproc_per_node=${GPU} tools/train_first_step.py -c configs/coco/${task}/e2e_faster_rcnn_R_50_C4_4x.yaml -cvd ${CUDA_VISIBLE_DEVICES}
