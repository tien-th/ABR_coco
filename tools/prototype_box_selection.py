...
def main():
    ...
    if args.step == 0:
        ...
        source_model_config_file = f"configs/coco/{args.task}/e2e_faster_rcnn_R_50_C4_4x.yaml"
    else:
        # source_model_config_file = f"configs/voc/{args.task}/e2e_faster_rcnn_R_50_C4_4x_RB_Target_model.yaml"
        source_model_config_file = f"configs/coco/{args.task}/e2e_faster_rcnn_R_50_C4_4x_RB_Target_model.yaml"
