...
def main():
    ...
    if args.memory_type is None:
        ...
        target_model_config_file = f"configs/{args.dataset}/{args.task}/e2e_faster_rcnn_R_50_C4_4x_Target_model.yaml"
    else:
        target_model_config_file = f"configs/{args.dataset}/{args.task}/e2e_faster_rcnn_R_50_C4_4x_RB_Target_model.yaml"
